...
static const _Circle_type_support_symbol_names_t _Circle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_custom_msg, msg, Circle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_custom_msg, msg, Circle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, test_custom_msg, msg, Circle)() {
  return &::test_custom_msg::msg::rosidl_typesupport_c::Circle_message_type_support_handle;
}
