...
static const _Circle_type_support_symbol_names_t _Circle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_custom_msg, msg, Circle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_custom_msg, msg, Circle)),
  }
};
...
{
  return &::test_custom_msg::msg::rosidl_typesupport_cpp::Circle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, test_custom_msg, msg, Circle)() {
  return get_message_type_support_handle<test_custom_msg::msg::Circle>();
}
