...
#include "test_custom_msg/msg/detail/circle__rosidl_typesupport_fastrtps_c.h"
...
#include "test_custom_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_test_custom_msg
...
using _Circle__ros_msg_type = test_custom_msg__msg__Circle;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_custom_msg
size_t get_serialized_size_test_custom_msg__msg__Circle(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Circle__ros_msg_type * ros_message = static_cast<const _Circle__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Circle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_test_custom_msg__msg__Circle(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_custom_msg
size_t max_serialized_size_test_custom_msg__msg__Circle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_custom_msg__msg__Circle;
    is_plain =
      (
...
static size_t _Circle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_test_custom_msg__msg__Circle(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_custom_msg, msg, Circle)() {
