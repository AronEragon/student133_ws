...
bool test_custom_msg__msg__circle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_custom_msg.msg._circle.Circle", full_classname_dest, 34) == 0);
  }
  test_custom_msg__msg__Circle * ros_message = _ros_message;
  {  // center
...
PyObject * test_custom_msg__msg__circle__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("test_custom_msg.msg._circle");
