...
{
  new (message_memory) test_custom_msg::msg::Circle(_init);
}

void Circle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<test_custom_msg::msg::Circle *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Circle_message_member_array[2] = {
  {
    ...
    offsetof(test_custom_msg::msg::Circle, center),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_custom_msg::msg::Circle, radius),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Circle_message_members = {
  ...
  "Circle",  // message name
  2,  // number of fields
  sizeof(test_custom_msg::msg::Circle),
...
{
  return &::test_custom_msg::msg::rosidl_typesupport_introspection_cpp::Circle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_custom_msg, msg, Circle)() {
  return &::test_custom_msg::msg::rosidl_typesupport_introspection_cpp::Circle_message_type_support_handle;
}
